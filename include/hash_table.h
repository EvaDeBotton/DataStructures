...
/********************to be inserted to HashTable.c************************
typedef struct hash_table
{
    size_t capacity;
    get_key_ty get_key_func;
    hash_function_ty hash_func;
...
/* hash_function_ty return size_t type after manipulation on the key*/
typedef size_t (*hash_function_ty)(const void* key);
...
* Time Complexity: O(1)
*******************************************************************************/
hash_ty* HTCreate(size_t capacity, hash_function_ty hash_func, get_key_ty get_key_func, is_match_func_ty match_func);
...
* Time Complexity: O(1)
*******************************************************************************/
void HTDestroy(hash_ty* hast_table);
...
*******************************************************************************/
int HTInsert(hash_ty* hash_table , void* data);
...
* Time Complexity: O(1), O(n) worst case
*******************************************************************************/
void HTRemove(hash_ty* hash_table ,void* key);
...
* Time Complexity: O(1), O(n) worst case
*******************************************************************************/
void *HTFind(const hash_ty* hash_table ,void* key);
...
*******************************************************************************/
int HTForEach(hash_table_ty *hash_table, operation_ty op, void *param);
...
* Time Complexity: O(1)
*******************************************************************************/
int HTIsEmpty(const hash_table_ty *hash_table);
...
* Time Complexity: O(n) n - number of elements.
*******************************************************************************/
size_t HTSize(const hash_table_ty *hash_table);
...
* Time Complexity: O(n) n - number of elements.
*******************************************************************************/
double HTGetLoadFactor(const hash_table_ty *hash_table);
...
* Time Complexity: O(n) n - number of elements.
*******************************************************************************/
double HTGetSD(const hash_table_ty *hash_table);
